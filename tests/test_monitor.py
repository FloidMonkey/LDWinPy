...
def sw(name="LAB-SG3452", port="gigabitEthernet 1/0/33", vlan="1",
       ip="192.168.10.2", chassis="6c:4c:bc:00:00:01",
       src="6c:4c:bc:00:00:01"):
...
def test_full_scenario():
    ...
    mikrotik = NeighborInfo(protocol="LLDP", switch_name="MikroTik-LAB",
                            port_id="bridge1/ether2", src_mac="c4:ad:34:00:00:03")
    mikrotik.raw["chassis_id"] = "c4:ad:34:00:00:04"
