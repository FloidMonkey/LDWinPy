...
- [LDWin](https://github.com/FloidMonkey/LDWin) — Link Discovery for Windows (AutoIt)
- [WinCDP](https://github.com/FloidMonkey/WinCDP) — Cisco Discovery Protocol Client for Windows (AutoIt)

Ambas creadas originalmente por **Chris Hall** ([chall32](https://github.com/chall32)),
...
- Concepto y herramientas originales: **Chris Hall** ([chall32](https://github.com/chall32)) —
  [LDWin](https://github.com/chall32/LDWin) / [WinCDP](https://github.com/chall32/WinCDP)
- Forks de referencia: [FloidMonkey/LDWin](https://github.com/FloidMonkey/LDWin) /
  [FloidMonkey/WinCDP](https://github.com/FloidMonkey/WinCDP)
- Reescritura Python multimarca: este proyecto
